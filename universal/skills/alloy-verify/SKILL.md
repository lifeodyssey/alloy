---
name: alloy-verify
description: Use before claiming work is complete, fixed, passing, or ready to commit/PR. Inline-fuses Superpowers verification-before-completion with Alloy evidence gates.
---

# Alloy Verify

This skill inlines Superpowers' evidence-before-claims rule first, then keeps Alloy's ledger, risk tier, and command-output requirements.

## Section 1: Superpowers Verification Before Completion (verbatim)

_Source: obra/superpowers v5.1.0 skills/verification-before-completion/SKILL.md (MIT)_
...
_Source: Current Alloy alloy-verify/SKILL.md body before Task 7, MIT._
...
- obra/superpowers v5.1.0 `skills/verification-before-completion/SKILL.md` — MIT; inlined verbatim.
- Alloy current `alloy-verify` integration layer — MIT / first-party Alloy.
