---
name: alloy-plan
description: Use when you have a spec or decision context and need a bite-sized implementation plan with TDD steps and exact file paths. Inline-fuses Superpowers writing-plans with Alloy source-coverage audit rules.
---
