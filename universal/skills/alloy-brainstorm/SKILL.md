...
description: Use this before creative work: creating features, building components, adding functionality, or modifying behavior. Inline-fuses Superpowers brainstorming with Alloy hard-gates and evidence capture.
---

# Alloy Brainstorm

This skill inlines the upstream Superpowers brainstorming workflow first, then keeps Alloy's integration rules for durable specs, hard gates, and ledger evidence.

## Section 1: Superpowers Brainstorming (verbatim)

_Source: obra/superpowers v5.1.0 skills/brainstorming/SKILL.md (MIT)_
...
_Source: Current Alloy alloy-brainstorm/SKILL.md body before Task 7, MIT._
...
- obra/superpowers v5.1.0 `skills/brainstorming/SKILL.md` — MIT; inlined verbatim.
- Alloy current `alloy-brainstorm` integration layer — MIT / first-party Alloy.
