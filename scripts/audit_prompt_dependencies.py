#!/usr/bin/env python3
"""Audit Alloy prompts for installable dependency references."""
...
DEPENDENCIES = (
    ...
    Dependency("alloy-plan", "alloy-plan", "skill", "repo", "skill", "keep: Alloy plan-writing entrypoint"),
    Dependency("alloy-execute", "alloy-execute", "skill", "repo", "skill", "keep: Alloy execution entrypoint"),
    Dependency("alloy-verify", "alloy-verify", "skill", "repo", "skill", "keep: Alloy verification entrypoint"),
    Dependency("alloy-map-codebase", "alloy-map-codebase", "skill", "repo", "skill", "keep: Alloy codebase mapping entrypoint"),
    Dependency("alloy-qa", "alloy-qa", "skill", "repo", "skill", "keep: Alloy QA entrypoint"),
