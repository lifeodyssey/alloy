...
Record evidence that an Alloy implementation satisfies its approved plan.

## Workflow

1. Invoke the `alloy-verify` skill.
2. Load the requested `.alloy/plans/<id>/plan.md`, progress, and findings.
...
5. Write output to `.alloy/plans/<id>/verification.md`.
