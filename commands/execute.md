...
2. Load the requested `.alloy/plans/<id>/plan.md` and review the plan before work starts.
...
5. Write output to `.alloy/plans/<id>/progress.md` and `.alloy/plans/<id>/findings.md`.
